    ...
    if (isset($_POST['DiaryName'])) {
        ...
        if(mysqli_num_rows($result) > 0){
           ...
           <h3> Someone has already registered using this email! </h3> <br/>
            Click here to go back. <a href='registration.php'>Try again</a></div>";
        } else {
            if (!filter_var($Email, FILTER_VALIDATE_EMAIL)) {
                echo "<div class='form'>
            <h3>Email format is not correct, Please try again!</h3>
            <br/>Click here to go back. <a href='registration.php'>Try again</a></div>";
            } else {
