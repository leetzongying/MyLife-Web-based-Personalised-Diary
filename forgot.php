...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/Web-based-Personalised-Diary/reset-password.php'.base64_encode($email).'">Reset Password</a></button></p>
     <br>
